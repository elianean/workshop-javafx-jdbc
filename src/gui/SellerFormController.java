...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (dpBirtDate.getValue() == null) {
			...
			Instant instant = Instant.from(dpBirtDate.getValue().atStartOfDay(ZoneId.systemDefault()));
		...
		obj.setDeparment(comboBoxDepartment.getValue());
	...
	public void updateFormData() {
		...
		if (entity.getBirthDate() != null) {
			dpBirtDate.setValue(LocalDate.ofInstant(entity.getBirthDate().toInstant(), ZoneId.systemDefault()));
		}
